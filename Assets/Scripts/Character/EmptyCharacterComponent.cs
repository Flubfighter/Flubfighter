...
public class EmptyCharacterComponent : MonoBehaviour
{
	public object movementInput, footstep, jumpStart, jumpEnd, airJumpStart, airJumpEnd, hitHead, grounded, ungrounded;
	public object punchChargeStart, punchChargeInterrupted, punchOvercharge, punchStart, punchEnd, punchEndSuddenly, punchCooldownEnd, punchButton, punchSomeone, getPunched, stompSomeone, getStomped, getThreatened, getUnthreatened;
	public object spawn, dieGeneric, dieBurn, dieCrush, dieDrown, dieElectrocute, dieFreeze, dieLazer, dieFall, deathAnimationEnd;
	public object pickUpItem, itemThrowStart, itemThrowEnd, itemThrowInterrupted, itemPlace, hitByItem, hitByFlubBall;
	public object tagByPotatoBomb, freeze, unfreeze, stun, unstun, stomp, unstomp, explode, explodeEnd, spawnProtectionEnd, teleport;
	public object pause, unpause, roundStart, roundEnd;
	
	// Common looping events
	public object punchChargeLoop, punchLoop, itemThrowLoop, freezeLoop, stunLoop, stompLoop, explodeLoop;
